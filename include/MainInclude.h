...
bool glb_isrFlag = false;
bool glb_ISREnded = false;
...
float glb_VCC = 0.0;
float glb_current = 0.0;
float glb_batteryVoltage = 0.0;
float glb_temperature = 0.0;
float glb_humidity = 0.0;
float glb_altitude = 0.0;
float glb_pressure = 0.0;
int glb_batteryADC = 0;
...
volatile unsigned long powerReading[300];
volatile unsigned long timeReading[300];
volatile unsigned long currentReading[300];
volatile char routineReading[300];
