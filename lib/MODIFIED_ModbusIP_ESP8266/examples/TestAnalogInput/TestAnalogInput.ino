...
void doThermostatDetect()
{
  ...
  static int glb_fanPulseCounter;
  word localval = 0;
  pulseCounter++;
  yield();
  ...
  if (fanPulseDuration > 100) glb_fanPulseCounter++;
